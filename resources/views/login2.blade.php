...
<body>
    ...
    <section id="contact">
        <div class="container-fluid wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <form action="{{route('login-staff-store')}}" method="post">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6 contact-form-box">
                                <div class="form-group">
                                    <input type="text" name="username" class="form-control @error('username') is-invalid @enderror" placeholder="Username (Staff ID)">
                                    @error('username')
