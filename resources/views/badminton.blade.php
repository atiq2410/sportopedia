...
<body>
    ...
    <div class="main">
        ...
        <div class="main-left">
            ...
            <div class="plan-image"><img src="img/badminton-court.jpg" alt="badminton-court-plan-view"></div>
            <div class="court-detail">
                <b>BADMINTON COURT</b><br>
        ...
        <div class="main-right">
            <form action="{{route('badminton-store')}}" method="post">
                @csrf
                <br>
                ...
                @foreach($badminton_court as $data)
